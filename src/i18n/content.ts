...
const content = {
  ko: {
    ...
    events: {
      title: '행사',
      description: '초문화네트워크의 연도별 행사와 초청장',
      eyebrow: 'Events Archive',
      heroTitle: '연도별 행사',
      heroBody: '초문화네트워크가 개최한 행사와 초청장을 연도별로 기록합니다.',
      archiveEyebrow: 'Archive',
      archiveTitle: '연도 선택',
      archiveLabel: '행사 연도',
      invitationsEyebrow: 'Invitations',
      invitationsTitle: '행사 초청장',
      pastEvent: '지난 행사',
      upcomingEvent: '예정 행사',
      readInvitation: '초청장 읽기',
      yearTitle: (year: string) => `${year}년 행사`,
      yearDescription: (year: string) => `${year}년 초문화네트워크 행사와 초청장`,
      yearLabel: (year: string | number) => `${year}년`,
      allEvents: '전체 행사',
      invitationTitle: '초청장',
      pastInvitation: '지난 행사 초청장',
      invitation: '행사 초청장',
      expand: '초청장 전문 펼쳐보기',
      collapse: '초청장 전문 접기',
      standalone: '초청장 독립 페이지에서 읽기',
      detailEyebrow: (year: number) => `Past Event Invitation · ${year}`,
      eventInfo: '행사 정보',
      date: '일시',
      location: '장소',
      viewMap: '지도에서 보기',
      viewYear: (year: number) => `${year}년 행사 보기`,
      overview: '창립 행사 개요',
      program: '내용',
      senderSuffix: '올림',
    },
  ...
  en: {
    ...
    events: {
      title: 'Events',
      description: 'Events and invitations from the Transcultural Network, organised by year',
      eyebrow: 'Events Archive',
      heroTitle: 'Events by Year',
      heroBody: 'Explore a year-by-year record of events and invitations from the Transcultural Network.',
      archiveEyebrow: 'Archive',
      archiveTitle: 'Browse by Year',
      archiveLabel: 'Event years',
      invitationsEyebrow: 'Invitations',
      invitationsTitle: 'Event Invitations',
      pastEvent: 'Past event',
      upcomingEvent: 'Upcoming event',
      readInvitation: 'Read invitation',
      yearTitle: (year: string) => `${year} Events`,
      yearDescription: (year: string) => `Transcultural Network events and invitations from ${year}`,
      yearLabel: (year: string | number) => String(year),
      allEvents: 'All events',
      invitationTitle: 'Invitations',
      pastInvitation: 'Past event invitation',
      invitation: 'Event invitation',
      expand: 'Read the full invitation',
      collapse: 'Hide the full invitation',
      standalone: 'Open the invitation page',
      detailEyebrow: (year: number) => `Past Event Invitation · ${year}`,
      eventInfo: 'Event Information',
      date: 'Date & Time',
      location: 'Location',
      viewMap: 'View on map',
      viewYear: (year: number) => `View all ${year} events`,
