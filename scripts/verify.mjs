...
// 사용: BASE_URL=http://localhost:4321 ROUTES=/ko/,/ko/about,/ko/about/founding,/ko/about/bylaws,/en/about/bylaws,/ko/people,/ko/seminars,/ko/seminars/2025-laos,/ko/contact,/en/ node scripts/verify.mjs
...
const ROUTES = (process.env.ROUTES || '/ko/,/ko/about,/ko/about/founding,/ko/about/bylaws,/en/about/bylaws,/ko/people,/ko/seminars,/ko/seminars/2025-laos,/ko/contact,/en/').split(',').map(s => s.trim()).filter(Boolean);
